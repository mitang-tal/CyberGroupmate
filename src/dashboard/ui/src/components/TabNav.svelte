<script>
  ...
  const tabs = [
    ...
    },
    {
      id: "execution",
      label: "执行中心",
      icon: "M16 2a14 14 0 1 0 14 14A14 14 0 0 0 16 2zm0 26a12 12 0 1 1 12-12 12 12 0 0 1-12 12zM9 12l-2 2 9 9 9-9-2-2-7 7z",
    },
    {
      id: "governance",
      label: "治理中心",
      icon: "M16 2l14 6v8c0 8.66-5.6 15.5-14 18C7.6 31.5 2 24.66 2 16V8l14-6zm0 2.31L4 9.68V16c0 7.32 4.62 13.14 12 15.54C23.38 29.14 28 23.32 28 16V9.68L16 4.31zM14 16.59l-2.29-2.3-1.42 1.42L14 19.41l7-7-1.41-1.42z",
    },
    {
      id: "intelligence",
      label: "智能中心",
      icon: "M16 2a9 9 0 0 0-9 9v1H5a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h2a9 9 0 0 0 18 0h2a1 1 0 0 0 1-1v-6a1 1 0 0 0-1-1h-2v-1a9 9 0 0 0-9-9zm7 12h4v6h-4v4h-2v-4H11v4H9v-4H5v-6h4v-3a7 7 0 0 1 14 0v3z",
    },
    {
      id: "mcp",
      label: "MCP",
	    ...
	    },
	{
	      id: "ecosystem",
	      label: "生态中心",
	      icon: "M16 2a14 14 0 1 0 14 14A14 14 0 0 0 16 2zm0 4a10 10 0 1 1-10 10A10 10 0 0 1 16 6zm-1 4v7l6 3.5 1-1.73-5-2.84V10z",
	    },
	    {
	      id: "stability",
	      label: "稳定性验证",
